...
f = Star(affliction, c, {"vitality":(11+21)/2, "poison resist":10})
...
c = Star(abomination, b, {"offense":40, "poison resist":20, "max poison resist":3})
...
c = Star(ulo, b, {"poison resist":15, "pet poison resist":15})
